...
export const departmentInvestigatorNavItems = [
  ...
  { to: '/department-investigator/cases', icon: Inbox, label: 'My Cases', end: true, section: 'Complaints' },
  { to: '/department-investigator/complaints', icon: FileText, label: 'All Complaints', section: 'Complaints' },
