...
export default function InvestigatorComplaintsPage() {
  const { user } = useAuth();
  ...
  const rows = complaints
    .filter((c) => c.investigatorId === officerId)
  ...
  return (
    <AppShell navItems={departmentInvestigatorNavItems} user={user}>
      <PageHeader title="All Complaints" subtitle="Every complaint you've ever been assigned to investigate."
