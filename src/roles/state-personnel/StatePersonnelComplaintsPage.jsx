...
export default function StatePersonnelComplaintsPage() {
  const { user } = useAuth();
  ...
  const rows = scopeComplaintsForUser(allComplaints, user)
  ...
  return (
    <AppShell navItems={statePersonnelNavItems} user={user}>
      <PageHeader title="All Complaints" subtitle="Every complaint you've ever been assigned to review."
