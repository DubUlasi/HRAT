import { LayoutDashboard, Inbox, CheckCircle2, FileText, AlertOctagon, Search, TrendingUp, FileBarChart, HelpCircle, Settings } from 'lucide-react';
...
export const departmentDirectorNavItems = [
  ...
  { to: '/department-director/complaints', icon: FileText, label: 'All Complaints', section: 'Complaints' },
