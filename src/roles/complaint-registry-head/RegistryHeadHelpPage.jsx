...
const FAQS = [
  ...
  { q: 'What happens after I assign a department?', a: 'The Department Director takes over from there, assigning a supervisor, then an investigation officer, until findings come back to the registry.' },
