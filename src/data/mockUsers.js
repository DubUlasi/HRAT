...
export const mockUsers = [
  ...
  },
  {
    ...
    password: DEMO_PASSWORD,
    role: 'complaint-registry-desk-officer',
    name: 'Mike Peter',
    avatarSrc: '/alicia.png',
    officerId: 'off-mike',
  ...
  },
  {
    ...
    password: DEMO_PASSWORD,
    role: 'department-investigation-officer',
    name: 'Henry Peter',
    avatarSrc: '/alicia.png',
    officerId: 'inv-henry',
    departmentId: 'civil-political',
...
export const ROLE_HOME = {
  'complaint-registry-head': '/registry-head',
  'complaint-registry-desk-officer': '/desk-officer',
  'department-director': '/department-director',
  'department-supervisor': '/department-supervisor',
  'department-investigation-officer': '/department-investigator',
