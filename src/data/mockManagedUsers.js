...
export const mockManagedUsers = [
  { id: 'user-registry-head', name: 'Sam Peter', email: 'sampete@example.com', role: 'complaint-registry-head', departmentId: null, status: 'active', deactivationReason: null, joinedDate: '2019-03-11', lastLoginAt: '2026-08-18T09:12:00.000Z' },
  { id: 'user-desk-officer', name: 'Mike Peter', email: 'mike@example.com', role: 'complaint-registry-desk-officer', departmentId: null, status: 'active', deactivationReason: null, joinedDate: '2020-06-02', lastLoginAt: '2026-08-19T14:40:00.000Z' },
  ...
  { id: 'user-department-investigator', name: 'Henry Peter', email: 'henry@example.com', role: 'department-investigation-officer', departmentId: 'civil-political', status: 'active', deactivationReason: null, joinedDate: '2021-02-08', lastLoginAt: '2026-08-19T16:30:00.000Z' },
  { id: 'inv-victoria', name: 'Victoria Peter', email: 'victoria@example.com', role: 'department-investigation-officer', departmentId: 'vulnerable-groups', status: 'active', deactivationReason: null, joinedDate: '2021-05-11', lastLoginAt: '2026-08-13T10:00:00.000Z' },
  { id: 'inv-samuel', name: 'Samuel Peter', email: 'samuel@example.com', role: 'department-investigation-officer', departmentId: 'eco-soc', status: 'active', deactivationReason: null, joinedDate: '2021-08-30', lastLoginAt: '2026-08-12T10:00:00.000Z' },
  { id: 'inv-blessing', name: 'Blessing Peter', email: 'blessing@example.com', role: 'department-investigation-officer', departmentId: 'women-children', status: 'inactive', statusHistory: [{ id: 'hist-seed-blessing-1', action: 'deactivated', reason: 'Extended leave of absence', at: '2026-06-02T10:00:00.000Z' }], joinedDate: '2021-10-04', lastLoginAt: '2026-06-02T10:00:00.000Z' },
  ...
  { id: 'user-pending-onboard', name: 'Ngozi Eze', email: 'ngozi.eze@example.com', role: 'department-investigation-officer', departmentId: 'eco-soc', status: 'pending', deactivationReason: null, joinedDate: '2026-08-18', lastLoginAt: null },
];
